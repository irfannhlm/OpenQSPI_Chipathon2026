/*******************************************************************************************************************
*
*      FILE NAME       : W25QxxNExxIx.v
*      DESCRIPTION     : Verilg TestBehch example of Winbond Electronics Corp. series Serial Flash Memory
*      VERSION         : Ver 1.0
*      RELEASE         : JUL, 2025
*      PART NUMBER     : W25QxxNExxIx
*      MEMORY DENSITY  : 8Mb-64Mb
*      Max.SPEED       : N/A   
*      AUTHOR          : Lydia Chao
*
*                                                 Copyright(c)  Winbond Electronics Corp., 2024. All rights reserved.
*******************************************************************************************************************/

`include "./W25QxxNExxIx_v1.0n.v"
/******************************************************************************
 TEST VECTORS
******************************************************************************/

module test_W25QxxNExxIx;

W25QxxNExxIx dut(CSn, CLK, DIO, DO, WPn, HOLDn, RESETn);
...
parameter Freq = 50;				// Frequency in Megahertz
