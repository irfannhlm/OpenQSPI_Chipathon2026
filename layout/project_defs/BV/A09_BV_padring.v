module A09_BV_padring (
  ...
  gf180mcu_fd_io__bi_t N01 (.CS(N01_CS), .SL(N01_SL), .IE(N01_IE), .OE(N01_OE), .PU(N01_PU), .PD(N01_PD), .A(N01_A), .PDRV0(N01_PDRV0), .PDRV1(N01_PDRV1), .Y(N01_Y), .PAD(N01), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  gf180mcu_fd_io__bi_t N02 (.CS(N02_CS), .SL(N02_SL), .IE(N02_IE), .OE(N02_OE), .PU(N02_PU), .PD(N02_PD), .A(N02_A), .PDRV0(N02_PDRV0), .PDRV1(N02_PDRV1), .Y(N02_Y), .PAD(N02), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  ...
  gf180mcu_fd_io__in_s W14 (.PU(W14_PU), .PD(W14_PD), .Y(W14_Y), .PAD(W14), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  gf180mcu_fd_io__in_c W15 (.PU(W15_PU), .PD(W15_PD), .Y(W15_Y), .PAD(W15), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  gf180mcu_fd_io__in_c W16 (.PU(W16_PU), .PD(W16_PD), .Y(W16_Y), .PAD(W16), .VSS(W12), .DVSS(W12), .VDD(W13), .DVDD(W13));
  ...
  gf180mcu_fd_io__brk5 BRK_N02_1 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_N02_2 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_N02_3 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_N02_4 (.VSS(W12));
  gf180mcu_fd_io__brk5 BRK_N02_5 (.VSS(W12));
